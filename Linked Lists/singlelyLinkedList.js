...
*/
    ...
    moveMinToFront() {
        ...
        let smallestPast = this.head;
        while (runner.next) {
            if(runner.next.data < smallest.data){
        ...
        if(smallest.next){
            smallestPast.next = smallest.next
        }
...
let secondSll = new SinglyLinkedList()

mySll.insertAtBackMany([6, 2, 3, 4])
secondSll.insertAtBackMany([5, 6, 7, 8])
